class StatisticService
  ...
  def live_online_users(value)
    Statistic.create(name: :live_online_users, value: value)
  end

  def recording_online_users(value)
    Statistic.create(name: :recording_online_users, value: value)
  end
